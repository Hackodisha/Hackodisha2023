        ...
        <div className="sm:block hidden mt-36 relative">
          <div className="topHead">
            <div className="grid grid-cols-4">
              <div className=" ml-24 col-span-2">
                <Image
                  ...
                  height={113}
                  alt="HackOdisha Logo"
                  className=" -mb-[48px] max-w-[25vw] "
                />
              </div>
              <p className="text-[#06EBE5] lg:text-4xl text-3xl mb-2 text-center">
                Sitemap
              </p>
              <p className="text-[#06EBE5] lg:text-4xl text-3xl mb-2 text-center">
                Socials
            ...
            <div className="grid grid-cols-4 text-white ">
              <div className="flex flex-col gap-8 md:gap-16 col-span-2 ml-24 py-12 lg:text-3xl text-xl leading-loose">
                <p>
                  Want to Become a Sponsor <br /> of HackOdisha 3.0?
                </p>
              <a href="mailto:sponsorships@hackodisha.tech" rel="noreferrer" target="_blank">
                <button className=" bg-[#CA40CD] rounded-[3.5rem] md:rounded-[3.5625rem] px-4 py-2  md:px-6 md:py-3 lg:px-12 lg:py-6 text-[#FFEAEA] text-[1rem] lg:text-[1.375rem] font-bold leading-[147%] hover:bg-fuchsia-400 ease-in duration-100 text-center w-fit">
                  Become a sponsor
                </button>
                </a>
              </div>
              ...
              <ul className="inline-flex flex-col text-start w-fit mx-auto lg:-mt-8 xl:-mt-12 mt-6 gap-4 text-lg md:text-2xl">
                <a href="/#hero"><li className="hover:text-slate-500 cursor-pointer ">Home</li></a>
            ...
            <hr />
            <h3 className="text-2xl mx-auto w-fit py-10 text-white max-w-[90vw] text-center">
