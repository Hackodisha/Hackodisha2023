            ...
            <div className='flex'>
                ...
                <div className='w-1/4'>
                    <div className='flex flex-col mt-[-65%] ml-[5%] p-1 '>
                        ...
                        <Image src={"/images/TextImages/Environment.svg"} alt="logo" width="100" height="100" className="w-[50%] p-[23%] bg7" />
                        <div className='flex flex-col bg9 p-[10%] '>
                            <Image src={"/images/TextImages/Women.svg"} alt="logo" width="100" height="100" className="w-[52%] mt-[30%]" />
                            <Image src={"/images/TextImages/HorizentalLine.svg"} alt="logo" width="100" height="100" className="w-[60%] mt-[18%]" />
                        </div>
                        <Image src={"/images/TextImages/Innovation.svg"} alt="logo" width="100" height="100" className="w-[50%] p-[18%] mt-[4%] bg10" />
                    </div>
                </div>
            </div>
            <div className='flex '>
