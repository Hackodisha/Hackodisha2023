            ...
            <div className='flex'>
                <div className='w-3/4'>
                    <div className='flex mt-[-18%] justify-evenly'>
                        <Image src={"/images/SecurityLogo.svg"} alt="logo" width="100" height="100" className="boundary1 p-2  " />
                        <Image src={"/images/SecurityText.svg"} alt="logo" width="100" height="100" className="w-[45%]  " />
                ...
                <div className='w-1/4'>
                    <div className='flex flex-col mt-[-65%] ml-[5%] p-1 '>
                        <h1 className='text-white text-[0.38rem] sm:text-sm md:text-base lg:text-xl xl:text-2xl 2xl:text-3xl w-[100%] p-[16%] flex justify-center text-center bg11'>HEALTHCARE</h1>
                        ...
                        <div className='flex flex-col bg8 p-[13%] '>
                            <h1 className='text-white text-[0.38rem] sm:text-sm md:text-base lg:text-xl xl:text-2xl 2xl:text-3xl w-[100%] p-[23%] flex justify-center text-center mt-[5%]'>WEB3</h1>
                            <Image src={"/images/HorizentalLine.svg"} alt="logo" width="100" height="100" className="w-[60%] mt-[30%]" />
                            <h1 className='text-white text-[0.38rem] sm:text-sm md:text-base lg:text-xl xl:text-2xl 2xl:text-3xl w-[100%] p-[23%] flex justify-center text-center '>ENVIRONMENT</h1>
                        </div>
                        <h1 className='text-white text-[0.38rem] sm:text-sm md:text-base lg:text-xl xl:text-2xl 2xl:text-3xl w-[100%] p-[28%] flex justify-center text-center bg16'>WOMAN<br />SECURITY</h1>
                        <h1 className='text-white text-[0.38rem] sm:text-sm md:text-base lg:text-xl xl:text-2xl 2xl:text-3xl w-[100%] p-[18%] flex justify-center text-center bg13 mt-[4%]'>OPEN<br />INNOVATION</h1>
